  ...
  return (
    <section id="home" className="hero-gradient min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 w-1 h-1 bg-white/40 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-40 left-20 w-1.5 h-1.5 bg-white/20 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        ...
        {/* Geometric shapes */}
        <div className="absolute top-32 right-40 w-12 h-12 border border-white/10 rotate-45 animate-pulse"></div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left animate-fade-in">
            ...
            <div className="flex flex-wrap gap-3 mb-8 justify-center md:justify-start">
              <div className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                <span className="text-white/90 text-sm">⚡ React</span>
              </div>
              <div className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                <span className="text-white/90 text-sm">🚀 Laravel</span>
              </div>
              <div className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                <span className="text-white/90 text-sm">📱 Mobile</span>
              </div>
              <div className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                <span className="text-white/90 text-sm">☁️ Cloud</span>
              </div>
            </div>
          ...
          <div className="flex justify-center md:justify-end animate-scale-in">
            <div className="relative">
              ...
              <div className="absolute -inset-2 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
              
              <div className="relative w-80 h-80 rounded-full overflow-hidden border-4 border-white/30 shadow-[var(--shadow-large)] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm">
                <img 
                  src={heroImage} 
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-cyan-500/90 to-blue-500/90 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 shadow-lg">
                <span className="text-white font-semibold text-sm">⭐ 50+ projetos</span>
              </div>
              
              {/* New floating badge */}
              <div className="absolute top-10 -left-8 bg-gradient-to-r from-green-500/90 to-teal-500/90 backdrop-blur-sm rounded-full px-3 py-1 border border-white/20 shadow-lg">
